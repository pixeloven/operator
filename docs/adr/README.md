...
| [0013](0013-stale-lock-publication-serialization.md) | Stale-lock publication serialization may modify bounded upstream surfaces | Accepted | Hosted stale-lock scheduling race correction |
