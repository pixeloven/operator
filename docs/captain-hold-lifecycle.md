...
Completion and teardown verification consult the active backlog first, then accept an exact Done row from `data/done-archive.md` only when it retains captain-hold annotations and a structurally valid current or legacy resolution record.
