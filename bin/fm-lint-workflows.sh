...
# A repository actionlint config is optional.
# Without one, actionlint's standard runner-label set rejects undeclared
# private labels before a workflow can strand required checks in a queue.
