<!-- PIXELOVEN-FORK-BANNER:START -->
> ### `operator` — a PixelOven soft fork of `firstmate`
>
> This repository is **[`pixeloven/operator`](https://github.com/pixeloven/operator)**, a
